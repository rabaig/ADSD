...
def main():
    ...
    client = pymongo.MongoClient("mongodb://adsd-rafi-spring2022:YZww1VtFP4MEEFrXSyzvaLHc3ZL4nlivNI0OwdzP5M84grQWzfKNNgnOU7gBlhFHxEZPEM1uQPaulVRuhgNjgQ==@adsd-rafi-spring2022.mongo.cosmos.azure.com:10255/?ssl=true&retrywrites=false&replicaSet=globaldb&maxIdleTimeMS=120000&appName=@adsd-rafi-spring2022@")
    try:
    ...
    document_id_1 = insert_sample_document(collection)
    document_id_2 = insert_sample_document(collection)
    document_id_3 = insert_sample_document(collection)
    document_id_4 = insert_sample_document(collection)
    document_id_5 = insert_sample_document(collection)
    document_id_6 = insert_sample_document(collection)
